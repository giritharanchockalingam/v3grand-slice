...
import { ICAnalysisTab } from '../../../components/dashboard/ICAnalysisTab';
import {
  TabDashboardIcon,
  TabChartIcon,
  TabConstructionIcon,
...
/** Brain/AI icon for IC Analysis tab */
function TabBrainIcon({ className }: { className?: string }) {
  return (
...
type TabKey = 'overview' | 'ic-analysis' | 'underwriting' | 'construction' | 'risks' | 'assumptions' | 'feasibility' | 'market-intel' | 'sensitivity' | 'revaluation' | 'audit';
...
const TABS: Array<{ key: TabKey; label: string; Icon: React.ComponentType<{ className?: string }>; requiresConstruction?: boolean }> = [
  ...
  { key: 'ic-analysis', label: 'IC Analysis', Icon: TabBrainIcon },
