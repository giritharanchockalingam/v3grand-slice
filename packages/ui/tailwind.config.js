  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'hero-pattern': 'linear-gradient(135deg, #0f766e 0%, #0d9488 25%, #14b8a6 50%, #2dd4bf 75%, #99f6e4 100%)',
        'dark-mesh': 'radial-gradient(at 80% 10%, rgba(20, 184, 166, 0.08) 0, transparent 50%), radial-gradient(at 20% 90%, rgba(59, 130, 246, 0.05) 0, transparent 50%)',
      },
      animation: {
